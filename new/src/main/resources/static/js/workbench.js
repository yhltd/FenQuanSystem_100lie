...
function getRenYuanList() {
    $ajax({
        ...
        if (res.code == 200) {
            console.log(res.data)
            $.session.set('personPower', JSON.stringify(res.data))
        }
    })
}
    ...
    $('#workBenchTable').bootstrapTable({
        ...
        columns: [
            ...
            },
            {
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].c == "√" && JSON.parse($.session.get('companyPower'))[0].c == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].d == "√" && JSON.parse($.session.get('companyPower'))[0].d == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].e == "√" && JSON.parse($.session.get('companyPower'))[0].e == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].f == "√" && JSON.parse($.session.get('companyPower'))[0].f == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].g == "√" && JSON.parse($.session.get('companyPower'))[0].g == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].h == "√" && JSON.parse($.session.get('companyPower'))[0].h == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].i == "√" && JSON.parse($.session.get('companyPower'))[0].i == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].j == "√" && JSON.parse($.session.get('companyPower'))[0].j == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].k == "√" && JSON.parse($.session.get('companyPower'))[0].k == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].l == "√" && JSON.parse($.session.get('companyPower'))[0].l == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].m == "√" && JSON.parse($.session.get('companyPower'))[0].m == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].n == "√" && JSON.parse($.session.get('companyPower'))[0].n == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].o == "√" && JSON.parse($.session.get('companyPower'))[0].o == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].p == "√" && JSON.parse($.session.get('companyPower'))[0].p == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].q == "√" && JSON.parse($.session.get('companyPower'))[0].q == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].r == "√" && JSON.parse($.session.get('companyPower'))[0].r == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].s == "√" && JSON.parse($.session.get('companyPower'))[0].s == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].t == "√" && JSON.parse($.session.get('companyPower'))[0].t == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].u == "√" && JSON.parse($.session.get('companyPower'))[0].u == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].v == "√" && JSON.parse($.session.get('companyPower'))[0].v == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].w == "√" && JSON.parse($.session.get('companyPower'))[0].w == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].x == "√" && JSON.parse($.session.get('companyPower'))[0].x == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].y == "√" && JSON.parse($.session.get('companyPower'))[0].y == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].z == "√" && JSON.parse($.session.get('companyPower'))[0].z == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].aa == "√" && JSON.parse($.session.get('companyPower'))[0].aa == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ab == "√" && JSON.parse($.session.get('companyPower'))[0].ab == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ac == "√" && JSON.parse($.session.get('companyPower'))[0].ac == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ad == "√" && JSON.parse($.session.get('companyPower'))[0].ad == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ae == "√" && JSON.parse($.session.get('companyPower'))[0].ae == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].af == "√" && JSON.parse($.session.get('companyPower'))[0].af == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ag == "√" && JSON.parse($.session.get('companyPower'))[0].ag == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ah == "√" && JSON.parse($.session.get('companyPower'))[0].ah == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ai == "√" && JSON.parse($.session.get('companyPower'))[0].ai == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].aj == "√" && JSON.parse($.session.get('companyPower'))[0].aj == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ak == "√" && JSON.parse($.session.get('companyPower'))[0].ak == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].al == "√" && JSON.parse($.session.get('companyPower'))[0].al == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].am == "√" && JSON.parse($.session.get('companyPower'))[0].am == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].an == "√" && JSON.parse($.session.get('companyPower'))[0].an == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ao == "√" && JSON.parse($.session.get('companyPower'))[0].ao == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ap == "√" && JSON.parse($.session.get('companyPower'))[0].ap == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].aq == "√" && JSON.parse($.session.get('companyPower'))[0].aq == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ar == "√" && JSON.parse($.session.get('companyPower'))[0].ar == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ass == "√" && JSON.parse($.session.get('companyPower'))[0].ass == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].at == "√" && JSON.parse($.session.get('companyPower'))[0].at == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].au == "√" && JSON.parse($.session.get('companyPower'))[0].au == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].av == "√" && JSON.parse($.session.get('companyPower'))[0].av == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].aw == "√" && JSON.parse($.session.get('companyPower'))[0].aw == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ax == "√" && JSON.parse($.session.get('companyPower'))[0].ax == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ay == "√" && JSON.parse($.session.get('companyPower'))[0].ay == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].az == "√" && JSON.parse($.session.get('companyPower'))[0].az == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ba == "√" && JSON.parse($.session.get('companyPower'))[0].ba == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bb == "√" && JSON.parse($.session.get('companyPower'))[0].bb == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bc == "√" && JSON.parse($.session.get('companyPower'))[0].bc == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bd == "√" && JSON.parse($.session.get('companyPower'))[0].bd == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].be == "√" && JSON.parse($.session.get('companyPower'))[0].be == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bf == "√" && JSON.parse($.session.get('companyPower'))[0].bf == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bg == "√" && JSON.parse($.session.get('companyPower'))[0].bg == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bh == "√" && JSON.parse($.session.get('companyPower'))[0].bh == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bi == "√" && JSON.parse($.session.get('companyPower'))[0].bi == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bj == "√" && JSON.parse($.session.get('companyPower'))[0].bj == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bk == "√" && JSON.parse($.session.get('companyPower'))[0].bk == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bl == "√" && JSON.parse($.session.get('companyPower'))[0].bl == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bm == "√" && JSON.parse($.session.get('companyPower'))[0].bm == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bn == "√" && JSON.parse($.session.get('companyPower'))[0].bn == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bo == "√" && JSON.parse($.session.get('companyPower'))[0].bo == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bp == "√" && JSON.parse($.session.get('companyPower'))[0].bp == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bq == "√" && JSON.parse($.session.get('companyPower'))[0].bq == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].br == "√" && JSON.parse($.session.get('companyPower'))[0].br == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bs == "√" && JSON.parse($.session.get('companyPower'))[0].bs == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bt == "√" && JSON.parse($.session.get('companyPower'))[0].bt == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bu == "√" && JSON.parse($.session.get('companyPower'))[0].bu == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bv == "√" && JSON.parse($.session.get('companyPower'))[0].bv == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bw == "√" && JSON.parse($.session.get('companyPower'))[0].bw == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bx == "√" && JSON.parse($.session.get('companyPower'))[0].bx == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].byy == "√" && JSON.parse($.session.get('companyPower'))[0].byy == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].bz == "√" && JSON.parse($.session.get('companyPower'))[0].bz == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ca == "√" && JSON.parse($.session.get('companyPower'))[0].ca == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cb == "√" && JSON.parse($.session.get('companyPower'))[0].cb == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cc == "√" && JSON.parse($.session.get('companyPower'))[0].cc == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cd == "√" && JSON.parse($.session.get('companyPower'))[0].cd == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ce == "√" && JSON.parse($.session.get('companyPower'))[0].ce == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cf == "√" && JSON.parse($.session.get('companyPower'))[0].cf == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cg == "√" && JSON.parse($.session.get('companyPower'))[0].cg == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ch == "√" && JSON.parse($.session.get('companyPower'))[0].ch == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ci == "√" && JSON.parse($.session.get('companyPower'))[0].ci == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cj == "√" && JSON.parse($.session.get('companyPower'))[0].cj == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ck == "√" && JSON.parse($.session.get('companyPower'))[0].ck == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cl == "√" && JSON.parse($.session.get('companyPower'))[0].cl == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cm == "√" && JSON.parse($.session.get('companyPower'))[0].cm == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cn == "√" && JSON.parse($.session.get('companyPower'))[0].cn == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].co == "√" && JSON.parse($.session.get('companyPower'))[0].co == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cp == "√" && JSON.parse($.session.get('companyPower'))[0].cp == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cq == "√" && JSON.parse($.session.get('companyPower'))[0].cq == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cr == "√" && JSON.parse($.session.get('companyPower'))[0].cr == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cs == "√" && JSON.parse($.session.get('companyPower'))[0].cs == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].ct == "√" && JSON.parse($.session.get('companyPower'))[0].ct == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cu == "√" && JSON.parse($.session.get('companyPower'))[0].cu == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cv == "√" && JSON.parse($.session.get('companyPower'))[0].cv == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cw == "√" && JSON.parse($.session.get('companyPower'))[0].cw == "√"){
                ...
                width: 150,
                formatter:function(value, row , index){
                    if(JSON.parse($.session.get('companyPower'))[0].cx == "√" && JSON.parse($.session.get('companyPower'))[0].cx == "√"){
