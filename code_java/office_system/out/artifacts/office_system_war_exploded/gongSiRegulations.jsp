...
<%--                    <td><input type="text" name="CW" value="${gs.CW}" class="input" style="background: transparent"></td> <td><input type="text" name="CX" value="${gs.CX}" class="input" style="background: transparent"></td> <td><a href="gongSiDelete?id=${gs.id}" style="color: black">删除</a></td>--%>
                </tr>
            </c:forEach>
        </table>
