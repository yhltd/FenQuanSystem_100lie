...
<div style="margin-bottom: 0px;width: 100%;padding-bottom: 0px;height: 70px;margin-left: 0px;line-height: 75px;background: url('img/apic26305.jpg');background-size:100% 100%; background-attachment: fixed;">
    <img src="img/logo.png" style="width: 80px;height: 70px;float: left;margin-bottom: 0px"/>
    <span>&nbsp;</span>
    <span style="font-size: 19px;color: #0f0f0f">云合未来分权编辑系统</span>
    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
    ...
    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
    <div style="position: absolute;top:15px;left:68%;">
        ...
        <span>&nbsp;</span>
        <img src="img/ttc.png" style="height: 40px;width: 40px">
        <a href="logout" style="font-size: medium;color: #0f0f0f">退出</a>
    </div>
</div>
...
<div class="easyui-layout" style="width:100%;height:550px;">
    <div data-options="region:'west',split:true" title="" style="width:230px">
        <div class="easyui-accordion" data-options="fit:true,border:false">
            ...
            <div title="&nbsp;&nbsp;&nbsp;公司" data-options="iconCls:'icon-reload',selected:true" style="padding:10px">
                ...
                <a href="javascript:void(0)" onclick="showcontent('公司规定')"><p style="font-size: 17px"><img
                        src="img/gd.png" style="height: 20px;width: 20px">&nbsp;&nbsp;公司规定</p></a>
                <a href="javascript:void(0)" onclick="showcontent('公司柱状图')"><p style="font-size: 17px"><img
                        src="img/zzt.png" style="height: 20px;width: 20px">&nbsp;&nbsp;公司柱状图</p></a>
                <a href="javascript:void(0)" onclick="showcontent('工作台')"><p style="font-size: 17px"><img
                        src="img/gzt.png" style="height: 20px;width: 20px">&nbsp;&nbsp;工作台</p></a>
            </div>
            <div title="&nbsp;&nbsp;&nbsp;人员" data-options="iconCls:'icon-man'" style="padding:10px;">
                ...
                <%--                    <a href="renYuanRegulations.jsp" style="color: black">人员权限规定</a><br>--%>
                <%--                    <a href="renYuanInit" style="color: black">人员柱状图</a><br>--%>
                <%----%>
                <a href="javascript:void(0)" onclick="showcontent('人员添加')"><p style="font-size: 17px"><img
                        src="img/rytj.png" style="height: 20px;width: 20px">&nbsp;&nbsp;人员添加</p></a>
                <a href="javascript:void(0)" onclick="showcontent('人员管理')"><p style="font-size: 17px"><img
                        src="img/rygl.png" style="height: 20px;width: 20px">&nbsp;&nbsp;人员管理</p></a>
                <a href="javascript:void(0)" onclick="showcontent('人员权限规定')"><p style="font-size: 17px"><img
                        src="img/gd.png" style="height: 20px;width: 20px">&nbsp;&nbsp;人员权限规定</p></a>
                <a href="javascript:void(0)" onclick="showcontent('人员柱状图')"><p style="font-size: 17px"><img
                        src="img/zzt.png" style="height: 20px;width: 20px">&nbsp;&nbsp;人员柱状图</p></a>
            ...
            <div title="&nbsp;&nbsp;&nbsp;操作" data-options="iconCls:'icon-search'" style="padding:10px">
                ...
                <a href="javascript:void(0)" onclick="showcontent('使用人员')"><p style="font-size: 17px"><img
                        src="img/syry.png" style="height: 20px;width: 20px">&nbsp;&nbsp;使用人员</p></a>
                <a href="logout" id="logout"><p style="font-size: 17px"><img src="img/tcc.png"
                                                                             style="height: 16px;width: 16px">&nbsp;&nbsp;退出
                </p></a>
            </div>
        </div>
    </div>
    <div data-options="region:'center',title:'主页',iconCls:'icon-ok'" style="margin-right: 10px">
        <div id="test" class="easyui-tabs" data-options="fit:true,border:false,plain:true">
            <div title="首页"
                 style="border: 1px solid #5bc0de;  height: 580px;width: 1000px;float: left;text-align: center;background-image: url('img/apic27286.png');">
                <br>
                <br>
                <h1 style="font-family: 微软雅黑;margin-top: 100px">欢迎使用！</h1>
                <h1 style="font-family: 微软雅黑;margin-top: 100px">云合未来分权编辑系统！</h1>
                </tfoot>
                </table>
        ...
        <%--                <div title="人员管理" data-options="href:'renYuan'" style="padding:10px"></div>--%>
        <%--                <div title="人员权限规定" data-options="href:'copy'" style="padding:10px"></div>--%>
